...
public class TFLiteHelper {
    ...
    // Construtor: recebe contexto e caminho do modelo
    public TFLiteHelper(Context context, String modelPath) throws IOException {
        ...
        // Carrega labels automaticamente
        labels = loadLabels(context, "labels.txt");
    }

    // Carrega arquivo .tflite dos assets
    ...
    // Método para reconhecer imagem
    public String recognizeImage(Bitmap bitmap) {
        // Pré-processa a imagem para o tamanho esperado pelo modelo
        ...
        // Pega índice com maior probabilidade
        int maxIndex = 0;
        float maxProb = 0;
    ...
    // Método estático para carregar labels de um arquivo
